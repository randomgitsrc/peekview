# P2 派发指引 — T075 plan-design-review

## 目标

评审 T075 的 P2-design.md，产出 `P2-review.md`。
...
- P2-design.md：方案设计
- P1-requirements.md：53 条 BDD

## 输入文件

1. `docs/tasks/T075-structured-data-viewer/P2-design.md`
2. `docs/tasks/T075-structured-data-viewer/P1-requirements.md`
3. `/home/kity/.agate/assets/review-roles/plan-design-review.md`
