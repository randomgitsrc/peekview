...
<dispatch_guide>
### 目标
为 T069 的 24 条 BDD 设计测试用例。产出 P3-test-cases.md + 测试代码。

### 约束
- ui_affected: true，需要 vitest 单测 + Playwright E2E
- 测试代码放在 frontend-v3/tests/ 目录下
- 每条 BDD-1~24 都有对应测试用例

### 上游关联
- P1-requirements.md：24 条 BDD
- P2-design.md：方案A async guard + Promise.race
