# P2 派发指引 — T085 plan-design-review

## 目标

评审 T085 P2-design.md，确认方案合理性 + DESIGN.md 一致性 + 无遗漏。

## 输入文件

1. `docs/tasks/T085-render-regression-fix/P2-design.md`
2. `docs/tasks/T085-render-regression-fix/P1-requirements.md`
3. `DESIGN.md`

## 门槛

- P2-review.md status: approved/rejected/needs-revision
- agent ≠ main
