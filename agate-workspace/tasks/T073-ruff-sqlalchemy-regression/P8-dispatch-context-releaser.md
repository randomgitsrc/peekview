...
<dispatch_guide>
### 目标
P8 发布准备：确认 bump_type、更新 CHANGELOG、产出 P8-release.md。

### 约束
- releaser 不执行 bump-version / git commit / git tag
- 只产出 P8-release.md
- bump_type: patch（bug 修复，不改 API 行为）
- 当前版本：0.11.0 → 目标版本：0.11.1
- packages: [backend/peekview]（只 bump peekview，不 bump mcp_server）

### 上游关联
- P7-consistency.md：双向一致，无 BLOCKER
- P2-design.md packages: [backend/peekview]
- P6-acceptance.md：13 BDD 全 PASS

### 输入文件
- /home/kity/oclab/peekview/docs/tasks/T073-ruff-sqlalchemy-regression/P2-design.md
- /home/kity/oclab/peekview/docs/tasks/T073-ruff-sqlalchemy-regression/P7-consistency.md
- /home/kity/oclab/peekview/VERSIONS.json
- /home/kity/oclab/peekview/CHANGELOG.md
</dispatch_guide>
...
<objective_info>
- 当前版本：peekview 0.11.0, mcp_server 0.10.0
- bump_type: patch → 0.11.1
