...
<dispatch_guide>
### 目标
P7 一致性检查：双向对照 P2-design.md 与实际实现，标注一致/偏差。

### 约束
- 双向检查：设计→实现 + 实现→设计
- 偏差用 [BLOCKER]/[OK]/[DEVIATION] 标记
- 检查 [DESIGN_GAP] 配对

### 上游关联
- P2-design.md：19 处修复映射 + pyproject.toml 配置
- P4-implementation.md：实际实现
- P6-acceptance.md：13 BDD 全 PASS

### 输入文件
- /home/kity/oclab/peekview/docs/tasks/T073-ruff-sqlalchemy-regression/P2-design.md
- /home/kity/oclab/peekview/docs/tasks/T073-ruff-sqlalchemy-regression/P4-implementation.md
- /home/kity/oclab/peekview/docs/tasks/T073-ruff-sqlalchemy-regression/P6-acceptance.md
</dispatch_guide>
...
<objective_info>
- P2 设计：19 处 SQLAlchemy 修复 + pyproject.toml E711/E712 ignore
- P4 实现：19 处修复 + ruff 格式化 + E711/E712 ignore
- P6 验收：13 BDD 全 PASS
</objective_info>
