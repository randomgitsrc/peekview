...
## 目标
对 P4 代码实现做独立评审：组件设计质量、与 DESIGN.md §6 一致性、可访问性。

## 约束
- agent≠main
- C8 映射：frontend → design-review

## 输入文件
1. `docs/tasks/T079-interaction-consistency/P2-design.md`
2. `docs/tasks/T079-interaction-consistency/P4-implementation.md`
3. `frontend-v3/src/components/AuthButton.vue`
4. `frontend-v3/src/components/UserMenu.vue`
5. `frontend-v3/src/views/LandingView.vue`
6. `frontend-v3/src/views/EntryListView.vue`
7. `frontend-v3/src/components/EntryDetailHeader.vue`

## 客观查证信息
- 1125 passed + 1 skipped（零回归）
- typecheck 通过
