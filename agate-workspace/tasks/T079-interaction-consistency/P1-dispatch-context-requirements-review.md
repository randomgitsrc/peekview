...
## 目标
对 P1-requirements.md 做独立评审：BDD 可验证性、隐含需求覆盖完整性、裁剪合理性。
...
## 上游关联
- P0-brief.md：4 处不一致 + 约束
- P1-requirements.md：16 条 BDD + 隐含需求

## 输入文件
1. `docs/tasks/T079-interaction-consistency/P1-requirements.md` — 被评审文件
2. `docs/tasks/T079-interaction-consistency/P0-brief.md` — 上游约束
