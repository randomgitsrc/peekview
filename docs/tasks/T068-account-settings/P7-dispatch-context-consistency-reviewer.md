...
对 T068 全阶段产出做跨文件一致性审查。

## 检查清单

1. **DESIGN_GAP 配对**：P4-implementation.md 中的 DESIGN_GAP 声明 → P7-consistency.md 逐条转抄 + REVIEWED 标记
2. **SCOPE+ 闭环**：P1-requirements.md 有 [SCOPE_RESOLVED] 标记
3. **跨文件一致性**：
   - P2 packages 与 P8 bump 范围一致？
   - P1 BDD 数 = P6 PASS 数？
   - P4 实现路径与 P2 方案设计吻合？
4. **未决项清零**：无残留 [NEED_CONFIRM]、[BLOCKER]、[DEVIATION-CRITICAL]；确认 [NO_NEED_CONFIRM] 存在

## 输入文件

- docs/tasks/T068-account-settings/P0-brief.md
- docs/tasks/T068-account-settings/P1-requirements.md
- docs/tasks/T068-account-settings/P2-design.md
- docs/tasks/T068-account-settings/P3-test-cases.md
- docs/tasks/T068-account-settings/P4-implementation.md
- docs/tasks/T068-account-settings/P6-acceptance.md

## 输出

docs/tasks/T068-account-settings/P7-consistency.md
...
- SCOPE+ 闭环
- 跨文件引用关键词（如 P2§packages、P4§impl-path）
