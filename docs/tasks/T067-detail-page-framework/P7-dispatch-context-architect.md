...
检查 P4 实现与 P2 设计的一致性，产出 P7-consistency.md。

## 重点

1. 双向一致性检查：设计→实现 + 实现→设计
2. P4 有 2 条 DESIGN_GAP，必须逐条审查并写入 P7-consistency.md：
   - DESIGN_GAP 1: 移动端 Sign in 用原生 button 而非 BaseButton
   - DESIGN_GAP 2: zen mode 用 v-show 而非纯 CSS
3. 检查 P2 SCOPE+ (zen mode 移动端) 是否已实现
4. 检查 P1 BDD 12 条是否全部有实现对应

## 输入文件

1. docs/tasks/T067-detail-page-framework/P2-design.md — 方案设计
2. docs/tasks/T067-detail-page-framework/P4-implementation.md — 实现说明（含 DESIGN_GAP）
3. docs/tasks/T067-detail-page-framework/P6-acceptance.md — 验收结果
4. frontend-v3/src/views/EntryDetailView.vue — 实现代码
5. frontend-v3/src/views/LandingView.vue — 首页实现
6. frontend-v3/src/styles/layout.css — 全局样式
