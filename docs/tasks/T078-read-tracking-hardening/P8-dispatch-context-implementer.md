...
产出 P8-release.md，含 bump_type、版本号变更确认、CHANGELOG 更新、临时资源清单。

## 约束

- 不执行 git commit/tag（主 Agent 执行）
- 当前版本：peekview v0.14.2 / mcp v0.10.0
- 本任务加新表 + 新功能（聚合表 + by_action/by_source + 来源分类 + 90 天清理 + admin stats），是 minor bump
- 预期版本：v0.15.0
- [PROD_NOT_TOUCHED]
...
1. docs/tasks/T078-read-tracking-hardening/P2-design.md — packages 声明
2. docs/tasks/T078-read-tracking-hardening/P7-consistency.md — 一致性确认
