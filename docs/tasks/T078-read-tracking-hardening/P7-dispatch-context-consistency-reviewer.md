...
- agent != main
- 检查 DESIGN_GAP 配对 / packages 一致 / BDD 覆盖一致 / gate_commands 一致
- [PROD_NOT_TOUCHED]

## 输入文件

1. docs/tasks/T078-read-tracking-hardening/P1-requirements.md
2. docs/tasks/T078-read-tracking-hardening/P2-design.md
3. docs/tasks/T078-read-tracking-hardening/P3-test-cases.md
4. docs/tasks/T078-read-tracking-hardening/P4-implementation.md
5. docs/tasks/T078-read-tracking-hardening/P5-test-results.md
6. docs/tasks/T078-read-tracking-hardening/P6-acceptance.md

## 门槛

- P7-consistency.md status: approved 或 needs-revision
- DESIGN_GAP 配对（无 DESIGN_GAP 则声明无）
- packages 一致性确认
- BDD 覆盖一致性确认（P1 34 条 → P3 34 测试 → P6 34 PASS）
