...
逐条验收 P1 的 34 条 BDD，产出 P6-acceptance.md + P6-evidence/。
...
- 所有 PASS 必须有证据文件引用
- 纯后端任务，无 UI 截图
- 证据类型：test-output.log（测试执行日志）
- [PROD_NOT_TOUCHED]

## 上游关联

- P1 34 条 BDD（BDD-01~BDD-34）
- P5 全量测试通过（1042 passed 0 failed）
- T078 专项测试 34/34 绿灯

## 输入文件

1. docs/tasks/T078-read-tracking-hardening/P1-requirements.md — 34 条 BDD
2. docs/tasks/T078-read-tracking-hardening/P5-test-results.md — 测试结果
3. backend/tests/test_read_tracking_hardening.py — 34 个测试

## 门槛

- 34 条 BDD 全部有 PASS/FAIL 判定
  * PASS 行必须有证据文件引用
- P6-evidence/ 非空
- P6-acceptance.md 含 agent 字段
