...
## 目标
为 T079 产出 P8-release.md。纯前端改动，需 build-frontend + bump peekview 版本。

## 约束
- 不执行 bump-version / git commit / git tag
- P2 packages: [frontend-v3] → 需 build-frontend + bump peekview 版本
- 当前版本：peekview 0.12.3（T083 刚 bump）

## bump_type 判定
- 加功能（AuthButton + UserMenu 组件 + BaseTag + 移除 Explore）→ minor
- 不改公共 API
- 无破坏性变更
...
## 门槛
- P8-release.md 含 bump_type: minor
- CHANGELOG 已更新
