...
## 目标
跨文件一致性审查：P2 设计 vs P4 实现一致性、P1 BDD vs P6 验收数量匹配。

## 输入文件
1. `docs/tasks/T079-interaction-consistency/P1-requirements.md`
2. `docs/tasks/T079-interaction-consistency/P2-design.md`
3. `docs/tasks/T079-interaction-consistency/P4-implementation.md`
4. `docs/tasks/T079-interaction-consistency/P6-acceptance.md`

## 客观查证信息
- P1 BDD 数：17
- P6 PASS 数：17
- P2 packages: [frontend], ui_affected: true
- P4 DESIGN_GAP: 有（测试基础设施问题），需 REVIEWED
