...
### 目标
对修订后的 P1-requirements.md 进行二次评审，确认 9 项修改意见已处理且无新问题。

### 约束
- 重点关注上一轮 9 项修改是否已正确处理
- 检查修订是否引入新问题
- agent 字段必须为 requirements-review（≠main）
- NEED_CONFIRM 标记必须已清除

### 上游关联
- 第一轮 review 发现 9 项问题（status: needs-revision）
- analyst 已修订 P1-requirements.md
- 新增 BDD-D2/M3/A1b/A2b/A3b，净化 When 子句，移除 NEED_CONFIRM

### 输入文件
- docs/tasks/T060-archived-visibility-auth-refresh/P1-requirements.md（修订后版本）
- docs/tasks/T060-archived-visibility-auth-refresh/P1-review.md（上一轮评审意见）
