...
|------|----------|------|------|--------|------|----------|----------|
| T019 | html-viewer-srcdoc-csp | 🔄 进行中 | P2-revision | 🔴 | — | 2026-06-22 | 2026-06-22 |
...
```markdown
# 修改前
| T001 | mcp-ns-map | 🔄 进行中 | P2-revision | P1 | 2026-06-10 | 2026-06-10 |

# P1 完成，进入 P2 后
| T001 | mcp-ns-map | 🔄 进行中 | P2-revision | P1 | 2026-06-10 | 2026-06-11 |
