...
| 序号 | 任务名称 | 状态 | 当前阶段 | 优先级 | 更新日期 |
|------|----------|------|----------|--------|----------|
| T048 | entry-lifecycle | 🔄 进行中 | P2 | 🟠 | 2026-07-07 |
...
| T048 | entry-lifecycle | 🔄 进行中 | P1 | 🟠 | 无 | 2026-07-07 | 2026-07-07 |
...
| 日期 | 操作 | 内容 |
|------|------|------|
| 2026-07-07 | 创建 T048 | entry-lifecycle 立项 — 过期→归档+可续命+可配置保留期 |
