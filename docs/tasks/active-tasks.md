...
|------|----------|------|------|--------|------|----------|----------|
| T018 | plantuml-start-markers | 🔄 进行中 | P4 | 🟠 | — | 2026-06-21 | 2026-06-21 |
...
```markdown
# 修改前
| T001 | mcp-ns-map | 🔄 进行中 | P4 | P1 | 2026-06-10 | 2026-06-10 |

# P1 完成，进入 P2 后
| T001 | mcp-ns-map | 🔄 进行中 | P2 | P1 | 2026-06-10 | 2026-06-11 |

# P2 评审通过，进入 P3 后
| T001 | mcp-ns-map | 🔄 进行中 | P4 | P1 | 2026-06-10 | 2026-06-11 |
```
