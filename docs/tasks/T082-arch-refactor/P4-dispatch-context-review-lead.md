...
<dispatch_guide>
### 目标
汇总两个 P4 评审意见（review + design-review），产出统一的 P4-review.md。

### 约束
- 不发表新意见，只汇总
- 任何专家标 CRITICAL/BLOCKER → status: rejected
- 全票无 BLOCKER → status: approved
- agent 字段填 review-lead

### 上游关联
- review 产出 P4-review-eng.md：status=approved，0 CRITICAL，4 INFORMATIONAL
- design-review 产出 P4-review-design.md：status=approved，3 INFO 非 BLOCKER
- 两个评审均 approved

### 输入文件
- docs/tasks/T082-arch-refactor/P4-review-eng.md
- docs/tasks/T082-arch-refactor/P4-review-design.md
</dispatch_guide>
