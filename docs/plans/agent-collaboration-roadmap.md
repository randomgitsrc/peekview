...
| T011 | Admin User API（后端）| backend | P0 | 无 |
| T012 | peekview admin user CLI | backend | P0 | T011 |
| T013 | user delete（local + remote）| backend | P0 | T011 |
| T014 | MCP path_namespace CLI | mcp-server | P0 | 无（已设计）|
| T015 | MCP config verify + unset | mcp-server | P1 | 无（已设计）|
| T016 | MCP list_entries 过滤参数 | mcp-server + backend | P1 | 无 |
...
- T012/T013 依赖 T011（Admin User API）
- T015/T016/T017 可并行
...
- T010 拆分为 T011（后端 API）+ T012（admin CLI）+ T013（user delete）
