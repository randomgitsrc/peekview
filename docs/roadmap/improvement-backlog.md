...
> 当前版本：Backend v0.10.0 / MCP Server v0.9.3
...
| 30 | P0-brief task_category 字段（🔧/🎯/🌱）+ 排期规则流程化 | 流程 | 🟠 近期 | ⬜ T063 |
| 31 | P8 自检清单加 `make dev`（防止 venv 依赖未同步导致测试虚设） | 流程/纠错 | 🔴 立即 | ⬜ 直接改 |
| 32 | MCP updateEntry 设计理由文档（解释为何 MCP 不暴露更新能力） | 文档 | 🟠 近期 | ⬜ 直接写 |
