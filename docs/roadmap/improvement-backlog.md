...
> 当前版本：Backend v0.1.56 / MCP Server v0.8.5
...
**已完成**：MCP Server v0.8.5 已迁移至 Streamable HTTP，端点从 `/sse` + `/messages` 改为 `/mcp`，SDK 升级至 1.29.0。详见已归档的 `docs/archived/plans/sse-migration/mcp-sse-to-streamable-http-migration.md`。
