...
用法:
  scripts/vision-analyze --image /tmp/screenshot.png --prompt "描述这张截图"
  scripts/vision-analyze -i /tmp/screenshot.png
  scripts/vision-analyze -i /tmp/screenshot.png -p "输出YAML" --format yaml
