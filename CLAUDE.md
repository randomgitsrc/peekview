...
- **Current Version:** v0.1.56 (Backend/Frontend) | MCP Server v0.8.5
...
### MCP Server Architecture (v0.8.5)
...
- **Version correspondence:** MCP Server v0.8.5 requires PeekView Backend v0.1.25+
