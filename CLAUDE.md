...
- **Current State:** Backend, frontend, and MCP Server are complete. MCP Server v0.8.0 (Streamable HTTP transport) has been released to npm.
- **Current Version:** v0.1.42 (Backend/Frontend) | MCP Server v0.8.0
...
### MCP Server Architecture (v0.8.0)
...
- **Version correspondence:** MCP Server v0.8.0 requires PeekView Backend v0.1.25+
