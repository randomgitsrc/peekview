...
- **Current State:** Backend, frontend, and MCP Server are complete. MCP Server v0.8.6 (Streamable HTTP transport) has been released to npm.
- **Current Version:** v0.1.60 (Backend/Frontend) | MCP Server v0.8.6
...
### MCP Server Architecture (v0.8.6)
...
- **Version correspondence:** MCP Server v0.8.6 requires PeekView Backend v0.1.25+
