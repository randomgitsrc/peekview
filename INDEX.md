...
> Backend/Frontend v0.1.58 · MCP Server v0.8.5
...
|------|------|
| 了解项目 | `README.md` |
| 开始开发 | `CLAUDE.md`（Claude Code）/ `OPENCODE.md`（OpenCode） |
...
| `docs/roadmap/improvement-backlog.md` | 待办改进项（含优先级） |

---

## 历史文档

过时的计划、评审、旧版工作流均在 `docs/archived/`，不影响日常开发。
